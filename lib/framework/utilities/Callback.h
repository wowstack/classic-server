    ...
    class _Callback
    {
      ...
      public:
        ...
        : m_object(cb.m_object), m_method(cb.m_method), m_param1(cb.m_param1), m_param2(cb.m_param2),
          m_param3(cb.m_param3), m_param4(cb.m_param4)
        {
        }
    };
...
namespace MaNGOS
{
    ...
    class Callback : public _ICallback<_Callback<Class, ParamType1, ParamType2, ParamType3, ParamType4>>
    {
      ...
      public:
        Callback(Class *object, typename C4::Method method, ParamType1 param1, ParamType2 param2, ParamType3 param3,
                 ParamType4 param4)
...
namespace MaNGOS
{
    ...
    class QueryCallback : public _IQueryCallback<_Callback<Class, QueryResult *, ParamType1, ParamType2, ParamType3>>
    {
      ...
      public:
        QueryCallback(Class *object, typename QC3::Method method, QueryResult *result, ParamType1 param1,
    ...
    : public _IQueryCallback<_Callback<Class, QueryResult *, ParamType1, ParamType2>>
    {
      ...
      public:
        QueryCallback(Class *object, typename QC2::Method method, QueryResult *result, ParamType1 param1,
                      ParamType2 param2)
    ...
    class SQueryCallback : public _IQueryCallback<_SCallback<QueryResult *, ParamType1, ParamType2, ParamType3>>
    {
      ...
      public:
        SQueryCallback(typename QC3::Method method, QueryResult *result, ParamType1 param1, ParamType2 param2,
                       ParamType3 param3)
